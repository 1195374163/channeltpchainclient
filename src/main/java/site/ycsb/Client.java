...
public final class Client {
    ...
    public static void main(String[] args) {
      ...
      * -threads 5
      * -p fieldlength=1024
      * -p hosts=192.168.136.133,192.168.136.134,192.168.136.135,192.168.136.129,192.168.136.128
      * -p readproportion=0
      * -p updateproportion=1
      * */
      
      // 命令行参数有  -s,说明这个值设为了true 
      ...
      // 对worklod设置操作选择器   key生成器  value的字段数量和长度的生成器
    ...
    /**
       * 如果初始化时间超过2秒，显示等待时间：睡眠2秒来显示提示信息
       * */
    ...
    private static Properties parseArguments(String[] args) {
      Properties props = new Properties();//暂存命令行参数
